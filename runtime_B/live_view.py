...
def render_live_html(ir: dict, title: str = "", model: str = "") -> str:
    ...
    cost_config = None
    if model:
        from runtime_B.cost import get_prices
...
// chat.send: agent broadcasts to group chat (runtime_base_1)
...
// chat.receive: agent reads message(s) from group chat (runtime_base_1)
