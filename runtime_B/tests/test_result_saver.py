"""Tests for runtime_B.result_saver."""
...
from runtime_B.result_saver import build_run_result_data, save_run_result


# --- Lightweight stubs (avoid importing full runtime_B machinery) ---
