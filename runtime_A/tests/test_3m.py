"""Tests for runtime_A with 3M research writing protocol (5 agents, 2 locks, 13 channels).
...
from runtime_A.engine import run_ir, RunResult
from runtime_A.policy import AgentPolicy
