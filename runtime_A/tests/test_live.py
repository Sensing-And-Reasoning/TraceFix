"""Tests for runtime_A live visualization: event bus, engine event emission."""

import asyncio

import pytest

from runtime_A.event_bus import EventBus, Event
from runtime_A.engine import Runtime, run_protocol, run_ir, RunResult
