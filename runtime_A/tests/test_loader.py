"""Tests for runtime_A.loader — loading states.json format."""

from pathlib import Path

import pytest

from runtime_A.loader import load_task, normalize_extracted_states
from runtime_A.engine import run_ir
from runtime_A.topology import build_topology
