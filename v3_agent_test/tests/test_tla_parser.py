...
from v3_agent_test.pipeline.tla_parser import (
    IRMetadata,
    ParseResult,
    build_ir_metadata,
...
def _guard_compat_case_ids() -> list[str]:
    ...
    base = Path(__file__).parent.parent.parent / "IRs"
    if not base.exists():
        return []
    ids = []
...
class TestInDegreeDedupMerge11M:
    ...
    def test_synthetic_same_target_dedup(self):
        ...
        from v3_agent_test.pipeline.tla_parser import _merge_receive_dispatch
...
class TestInferElseLabelsMultiChannel:
    ...
    def test_infer_per_channel(self):
        ...
        from v3_agent_test.pipeline.tla_parser import _infer_else_labels
