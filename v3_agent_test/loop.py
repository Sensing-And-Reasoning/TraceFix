...
from v3_agent_test.tool_client import AgentResponse, ToolCall, ToolClient
from v3_agent_test.tools import TOOL_REGISTRY
...
class AgentLoop:
    ...
    def _maybe_compress_context(self) -> None:
        ...
        try:
            from v3_agent_test.pipeline.llm_client import LLMClient
